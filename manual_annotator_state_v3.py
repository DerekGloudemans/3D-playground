...
class Annotator():
    ...
    def create_trajectory(self,idx,y_order = 2, x_order = 3, plot = True,weight = True,metric = "ape",verbose = True,complexity = 2):
        """
...
if __name__ == "__main__":
    ...
    if False: # run to do final spline fitting and timestamp adjustment
        ...
        ann.get_splines(plot = True,metric = spl_met)
        ...
        with open("cached_final_ann_{}.cpkl".format(scene_id),"wb") as f:
            pickle.dump([ann.data,ann.all_ts,ann.splines],f)    
