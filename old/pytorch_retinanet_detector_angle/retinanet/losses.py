    ...
    def forward(self, classifications, regressions, anchors, annotations):
        ...
        for j in range(batch_size):
            ...
            if positive_indices.sum() > 0:
                ...
                # if the front of the target is closer to the vanishing point than the back, we multiply cos_term by 1
                ...
                targ_vec_x = obj_ctr_x - vp[:,0]
                targ_vec_y = obj_ctr_y - vp[:,1]
                ...
                targ_vec_x = obj_ctr_x - vp[:,2]
                targ_vec_y = obj_ctr_y - vp[:,3]
                ...
                targ_vec_x = obj_ctr_x - vp[:,4]
                targ_vec_y = obj_ctr_y - vp[:,5]
